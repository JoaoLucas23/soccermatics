# -*- coding: utf-8 -*-
"""
Created on Wed Nov 16 22:27:42 2022
...
#open the data
parser = Sbopen()
#get the match by competition id and season id
df_match = parser.match(competition_id=72, season_id=30)
#define target team
team = "England Women's"
#get list of games by targer team, either home or away
match_ids = df_match.loc[(df_match["home_team_name"] == team) | (df_match["away_team_name"] == team)]["match_id"].tolist()
#calculate number of games
no_games = len(match_ids)

'''
                Getting Dangerous passes
Dangerous passes are passes that were made on the 15s before a shot
'''
